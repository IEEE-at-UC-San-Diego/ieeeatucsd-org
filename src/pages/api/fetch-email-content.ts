      ...
      try {
        ...
        if (message) {
          ...
          if (bodyParts) {
            ...
            const textPart = bodyParts.get('1.1') || bodyParts.get('1') || bodyParts.get('TEXT');
            if (textPart) {
              try {
          ...
          console.log(`Successfully fetched email content. HTML: ${htmlContent.length > 0}, Text: ${textContent.length > 0}, Attachments: ${attachments.length}`);
        }
