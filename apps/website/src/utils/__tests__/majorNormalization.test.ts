...
describe("toTitleCase", () => {
  it("should convert simple strings to title case", () => {
    ...
    expect(toTitleCase("ELECTRICAL ENGINEERING")).toBe(
      "Electrical Engineering",
    );
    expect(toTitleCase("mechanical engineering")).toBe(
      "Mechanical Engineering",
    );
  });

  it("should keep conjunctions lowercase", () => {
    expect(toTitleCase("computer science and engineering")).toBe(
  ...
  it("should keep prepositions lowercase", () => {
    ...
    expect(toTitleCase("master of arts in education")).toBe(
...
describe("normalizeMajorName", () => {
  it("should normalize basic major names", () => {
    ...
    expect(normalizeMajorName("ELECTRICAL ENGINEERING")).toBe(
      "Electrical Engineering",
    );
    expect(normalizeMajorName("  mechanical engineering  ")).toBe(
      "Mechanical Engineering",
    );
  });
  ...
  it("should handle conjunctions properly", () => {
    expect(normalizeMajorName("computer science and engineering")).toBe(
      "Computer Science and Engineering",
    );
    expect(normalizeMajorName("Computer Science And Engineering")).toBe(
      "Computer Science and Engineering",
...
describe("normalizeToCanonical", () => {
  it("should normalize to canonical form from known majors", () => {
    ...
    expect(normalizeToCanonical("computer science", knownMajors)).toBe(
      "Computer Science",
    );
    expect(normalizeToCanonical("COMPUTER SCIENCE", knownMajors)).toBe(
      "Computer Science",
  ...
  it("should return normalized form for unknown majors", () => {
    ...
    expect(normalizeToCanonical("mechanical engineering", knownMajors)).toBe(
      "Mechanical Engineering",
    );
  });
