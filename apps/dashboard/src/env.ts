...
export const env = createEnv({
	server: {
		...
		CONVEX_AUTH_STRATEGY: z.enum(["bridge", "jwt"]).optional(),
	...
	client: {
		...
		VITE_CONVEX_AUTH_STRATEGY: z.enum(["bridge", "jwt"]).optional(),
	...
	runtimeEnv: {
		...
		CONVEX_AUTH_STRATEGY: process.env.CONVEX_AUTH_STRATEGY,
		...
		VITE_CONVEX_AUTH_STRATEGY: import.meta.env.VITE_CONVEX_AUTH_STRATEGY,
