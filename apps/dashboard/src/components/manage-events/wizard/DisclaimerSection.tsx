	...
	return (
		<div className="space-y-5">
				...
				<div className="flex items-start gap-3">
					...
					<div>
						...
						<p className="text-sm text-yellow-700 mt-1">
							Please read these requirements carefully before submitting your
							event request.
						</p>
					</div>
				</div>
					...
					<div className="flex items-start gap-2">
						...
						<div>
							...
							<p className="text-blue-700 mt-1 text-xs">
								When uploading receipts for your events, they will be
								automatically parsed by our AI system. It is{" "}
								<strong>
									your responsibility to verify the extracted data
								</strong>{" "}
								and fix any discrepancies. Once submitted, the request cannot be
								changed.
							</p>
						</div>
					</div>
					...
					<div className="flex items-start gap-2">
						...
						<div>
							...
							<ul className="list-disc list-inside space-y-1 mt-1.5 text-gray-600 text-xs">
								<li>
									AS Funding requires submission <strong>5 weeks</strong> before
									the event date
								</li>
								<li>
									VC Operations requires submission{" "}
									<strong>7 business weeks</strong> before the event date if you
									want AS Funding (for Food or Flyers)
								</li>
								<li>
									VC Operations requires submission <strong>4 weeks</strong>{" "}
									before the event date without AS Funding (for Food or Flyers)
								</li>
					...
					<div className="flex items-start gap-2">
						...
						<div>
							...
							<ul className="list-disc list-inside space-y-1 mt-1.5 text-amber-700 text-xs">
								<li>
									Maximum <strong>$5,000</strong> per event
								</li>
					...
					<div className="flex items-start gap-2">
						...
						<div>
							...
							<div className="space-y-1.5 mt-1.5 text-red-700 text-xs">
								<p>
									<strong>Food Safety:</strong> All food must be from approved
									AS vendors and follow university food safety guidelines.
									Home-cooked food is not permitted unless approved by VC
									Operations.
								</p>
								<p>
									<strong>Liability:</strong> Event organizers are responsible
									for ensuring all activities comply with university policies
									and safety requirements.
								</p>
								<p>
									<strong>Cancellation:</strong> If you need to cancel or
									significantly modify your event, notify us immediately to
									avoid unnecessary expenses / hassles.
								</p>
								<p>
									<strong>Post-Event:</strong> Submit photos within 48 hours of
									your event within the Google Drive for record-keeping.
								</p>
							</div>
						</div>
					</div>
					...
					<div className="flex items-start gap-2">
						...
						<div>
							...
							<p className="text-green-700 mt-1 text-xs">
								If you have questions about any of these requirements or need
								assistance with your event planning, please contact{" "}
								<strong>VC Operations on Slack</strong>.
							</p>
						</div>
					</div>
				</div>
			...
			<div className="flex items-start gap-3 pt-4 border-t">
				...
				>
					I have read and understood the above requirements. I agree to comply
					with all policies and requirements for hosting this event.
				</label>
			</div>
		</div>
	);
